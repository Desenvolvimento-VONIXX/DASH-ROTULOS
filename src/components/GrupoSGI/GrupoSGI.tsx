        ...
        <>
            <div className="flex-1 space-y-4 p-8 pt-6">
                <div className="flex items-center justify-between space-y-2 mb-7">
                    <h2 className="text-3xl font-bold tracking-tight ">Grupo SGI - Rótulos</h2>
                </div>
            ...
            {modalDetails && <ModalVerDetalhesSGI open={modalDetails} onClose={onClose} idClick={idClick} refetchRotuloProduto={refetch} />}
