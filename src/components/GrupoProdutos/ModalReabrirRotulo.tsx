...
const ModalReabrirRotulo: React.FC<Props> = ({ open, onClose, idClick, refetchRotulo, refetchRotuloProduto, refetchLinhaTempo }) => {
    ...
    return (
        <AlertDialog open={open} onOpenChange={onClose}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Reabrir Rótulo</AlertDialogTitle>
                    <AlertDialogDescription>
                        Tem certeza de que deseja reabrir este rótulo? Essa ação exigirá uma nova avaliação.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
