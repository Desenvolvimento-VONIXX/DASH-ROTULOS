...
const NewRotuloPDI: React.FC<Props> = ({ open, onClose, refetch }) => {
    ...
    const salvaFormula = async (values: z.infer<typeof formSchema>, idRotulo: number) => {
        try {
            const response = await JX.salvar(
                {
                    ID_ROTULO: idRotulo,
            ...
            if (response.status === "1") {
                ...
                toast.success('Rótulo e Fórmula salva com sucesso!', {
                    duration: 4000,
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-h-[80vh] overflow-hidden">
                <DialogHeader>
                    ...
                    <DialogDescription>Preencha os campos abaixo para criar um novo rótulo com a fórmula atualizada.</DialogDescription>
                </DialogHeader>
