...
const GrupoPDI: React.FC<Props> = () => {
    ...
    const filteredRotulos = (rotulosPDI || []).filter((rotulo: Rotulo) =>
        ...
        <>
            <div className="flex-1 space-y-4 p-8 pt-6">
                <div className="flex items-center justify-between space-y-2 mb-7">
                    <h2 className="text-3xl font-bold tracking-tight ">Grupo PDI - Rótulos</h2>
            ...
            {modalDetails && <ModalVerDetalhesPDI open={modalDetails} onClose={onClose} idClick={idClick} />}
            {modalNewRotulo && <NewRotuloPDI open={modalNewRotulo} onClose={onCloseNewRotulo} refetch={refetch} />}
